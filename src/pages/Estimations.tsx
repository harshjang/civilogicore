  ...
  return (
    <div className="p-8 space-y-6">
      <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-2xl font-mono font-bold text-foreground">Estimations</h1>
        <p className="text-sm text-muted-foreground font-mono mt-1">EARTHWORK · MATERIAL · STRUCTURAL CALCULATIONS</p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-mono text-sm font-semibold text-foreground">QUICK CALCULATOR</h2>
          </div>

          <div className="space-y-4">
            <div>
              <label className="font-mono text-xs text-muted-foreground uppercase mb-2 block">Calculation Type</label>
        ...
        {/* Result */}
        <motion.div
          className="bg-card rounded-lg border border-glow p-6 space-y-5"
          initial={{ opacity: 0, x: 10 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <h2 className="font-mono text-sm font-semibold text-foreground">RESULT</h2>
          </div>

          <div className="space-y-4">
            <div className="p-4 bg-secondary/50 rounded-lg border border-border">
              <p className="font-mono text-xs text-muted-foreground uppercase">Volume</p>
            ...
            <div className="p-3 bg-primary/5 border border-primary/20 rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-xs text-primary font-semibold">FORMULA</span>
              </div>
      ...
      >
        <div className="p-5 border-b border-border">
          <h2 className="font-mono text-sm font-semibold text-foreground">RECENT ESTIMATES</h2>
        </div>
        <div className="divide-y divide-border/50">
          {[
            ...
            <div key={est.name} className="px-5 py-4 flex items-center justify-between hover:bg-secondary/20 transition-colors">
              <div>
                <p className="text-sm text-foreground font-mono">{est.name}</p>
                <p className="text-xs text-muted-foreground font-mono mt-0.5">{est.type} · {est.date}</p>
              </div>
              <span className="font-mono text-sm font-semibold text-primary">{est.vol}</span>
            </div>
          ))}
        </div>
      </motion.div>
